...
def parse():
    ...
    parser.add_argument('--accelerations', type=int, default=[4, 8], nargs="+", help='accelerations on which the model will be trained')
...
def add_augmentation_specific_args(parser):
    ...
    parser.add_argument("--center_fractions", nargs="+", default=[0.08, 0.08], type=float, help="Number of center lines to use in mask",)
    return parser
